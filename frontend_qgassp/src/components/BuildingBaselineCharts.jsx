...
export const BuildingBaselineCharts = ({
  ...
  if (
    nextNewUnitsView === false &&
    Object.keys(emissionsByEndUse).length !== 0
  ) {
    return (
      <article>
        <br />
              ...
              data={[
                {
                  y:
                    Math.round(
                      (emissionResidential.bus + Number.EPSILON) * 100
                    ) / 100,
                  x: "Bus",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.metro + Number.EPSILON) * 100
                    ) / 100,
                  x: "Metro",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.train + Number.EPSILON) * 100
                    ) / 100,
                  x: "Train",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.road_transport + Number.EPSILON) *
                        100
                    ) / 100,
                  x: "Road transport",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.car + Number.EPSILON) * 100
                    ) / 100,
                  x: "Car",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.tram + Number.EPSILON) * 100
                    ) / 100,
                  x: "Tram",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.rail_transport + Number.EPSILON) *
                        100
                    ) / 100,
                  x: "Rail transport",
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.waterways_transport +
                        Number.EPSILON) *
                        100
                    ) / 100,
                ...
                },
                {
                  y:
                    Math.round(
                      (emissionResidential.total + Number.EPSILON) * 100
                    ) / 100,
                  x: "total emissions",
                },
              ]}
                ...
                data={[
                  {
                    angle:
                      Math.round(
                        (emissionResidential.bus / emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                    label: "Bus",
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.metro / emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                    label: "Metro",
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.train / emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                    label: "Train",
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.road_transport /
                          emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.car / emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                    label: "Car",
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.tram / emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
                    label: "Tram",
                  ...
                  },
                  {
                    angle:
                      Math.round(
                        (emissionResidential.rail_transport /
                          emissionResidential.total +
                          Number.EPSILON) *
                          36000
                      ) / 100,
