    ...
    if (nextNewUnitsView === false){
     return (
       <article>
         ...
         <Divider textAlign="left" flexItem>
           <b>Baseline - CO2e emissions from the energy use in residential buildings by unit type</b>
         </Divider>
         ...
         <Divider textAlign="left" flexItem>
           {" "}
           <b>Baseline - CO2e emissions from the energy use in commercial buildings by the end use</b>
         </Divider>
