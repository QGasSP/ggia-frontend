                  ...
                  <form id="from_landusechange_type" onSubmit={setLandUseChange}>
                    ...
                    <table >
                        ...
                        <tr>
                            ...
                            <td>
                                <input className="table-cell" type="text" placeholder="no change" disabled/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input className="table-cell" type="text" placeholder="empty" disabled/>
                            </td>
                            <td>
                                <input className="table-cell" type="text" placeholder="no change" disabled/>
                            </td>
                    ...
                    <div>
                      <label htmlFor="landToPeatExtraction" className="settle_label">
