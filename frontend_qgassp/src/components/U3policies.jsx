...
export const U3policies = () =>
...
} */
  {
    ...
    const freightTrans = localStorage.getItem("freightTrans")|| "";

    const modalPassShares = localStorage.getItem("modalPassShares ") || 0;
    const modalSplitPass = localStorage.getItem("modalSplitPass ")|| "";
    const modalFreShares = localStorage.getItem("modalFreShares")|| 0;
    const modalSplitFre = localStorage.getItem("modalSplitFre")|| "";
