...
U3policies.propTypes = {
  ...
  expectedChange: PropTypes.number.isRequired,
  affectedArea: PropTypes.number.isRequired,
  yearStart: PropTypes.number.isRequired,
  yearFinish: PropTypes.number.isRequired,
  bus: PropTypes.number.isRequired,
  metro: PropTypes.number.isRequired,
  tram: PropTypes.number.isRequired,
  train: PropTypes.number.isRequired,
  car: PropTypes.number.isRequired,
  affectedPopulation: PropTypes.number.isRequired,
  railTransport: PropTypes.number.isRequired,
  waterwaysTransport: PropTypes.number.isRequired,
  roadTransport: PropTypes.number.isRequired,
  lpg: PropTypes.number.isRequired,
  cng: PropTypes.number.isRequired,
  electricity: PropTypes.number.isRequired,
  petrol: PropTypes.number.isRequired,
  diesel: PropTypes.number.isRequired,
  ngv: PropTypes.number.isRequired,
  hep: PropTypes.number.isRequired,
  phev: PropTypes.number.isRequired,
  hydrogenfuel: PropTypes.number.isRequired,
  bioethanol: PropTypes.number.isRequired,
  biodiesel: PropTypes.number.isRequired,
  bifuel: PropTypes.number.isRequired,
  other: PropTypes.number.isRequired,
  renewables: PropTypes.number.isRequired,
